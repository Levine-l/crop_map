...
This visualisation turns main outputs from dissertation's result into figures and interactive maps.
...
| Name | Dashboard section | Dissertation role |
| --- | --- | --- |
...
| k sensitivity table | Crop-Profile Geography | Results |
